...
def is_duplicated_number(three_digit):
    ...
    result = False
    num =list(set(map(int, str(three_digit))))
    if len(num) <3:
        result = True
    # ==================================
    return result
...
def is_validated_number(user_input_number):
    ...
    if not is_digit(user_input_number):
        result = False
    elif is_duplicated_number(user_input_number) or not is_between_100_and_999(user_input_number):
        result = False
    # ==================================
    return result
...
def main():
    ...
    while not game_over:
        ...
        while True:
            ...
            data = get_strikes_or_ball(user_input, random_number)
            print(f'Strikes : {data[0]} , Balls : {data[1]}')
            if data == [3,0]: 
                break
